...
<script>
  ...
  import GlobalSnackbar from '@/core/views/GlobalSnackbar';
  import SkipNavigationLink from '@/core/views/SkipNavigationLink';
  import AppError from '@/core/views/AppError';
