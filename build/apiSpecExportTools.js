...
/*
 * From <https://github.com/learningequality/kolibri/blob/develop/packages/kolibri-tools/lib/apiSpecExportTools.js>
 */
...
const specFilePath = path.resolve(
  path.join(__dirname, '../src/core/core-app/apiSpec.js')
);
...
const baseAliasSourcePaths = {
  kolibri_module: path.resolve(__dirname, '../src/core/kolibri_module'),
  kolibri_app: path.resolve(__dirname, '../src/core/kolibri_app'),
  content_renderer_module: path.resolve(
    __dirname,
    '../src/core/content_renderer_module'
  ),
  plugin_data: path.resolve(__dirname, '../src/core/utils/plugin_data_src'),
